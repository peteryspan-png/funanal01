  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 space-y-20">
      <header className="text-center space-y-4">
        <h1 className="text-4xl font-bold text-beige-50">장례 지원 안내</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
          {steps.map((step, i) => (
            <motion.div 
              ...
              className="bg-sage-900/50 p-8 rounded-[2rem] text-center shadow-sm border border-sage-800/50"
            >
              <div className="w-16 h-16 bg-sage-800 text-beige-100 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg border border-sage-700">
                <step.icon size={32} />
              </div>
              <h3 className="text-lg font-bold mb-2">{step.title}</h3>
              <p className="text-sm text-beige-100 leading-relaxed font-medium">{step.desc}</p>
            </motion.div>
          ))}
        </div>
      </section>
        ...
        <div className="space-y-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <ul className="space-y-2 text-beige-100 list-disc pl-5 font-medium">
        ...
        <div className="bg-sage-900 rounded-[3rem] p-10 text-white space-y-8">
          ...
          <div className="space-y-4">
            <a 
              ...
              className="flex items-center justify-center gap-3 bg-sage-100 text-sage-950 py-5 rounded-2xl font-bold text-xl hover:bg-white transition-all"
            >
